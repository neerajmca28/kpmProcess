      ...
      <div class="navbar navbar-default">
        <div class="navbar-header">
          <a class="navbar-brand navbar-brand-center" href="index.html">
            <img class="navbar-brand-logo" src="<?= base_url(); ?>assets/img/Logo_gtrac.png" alt="GTRAC">
          </a>
          ...
          <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
            ...
            <!--   <img class="ellipsis-object" width="32" height="32" src="<?= base_url(); ?>assets/<?= base_url(); ?>assets/img/0180441436.jpg" alt="Teddy Wilson"> -->
            </span>
          </button>
        </div>
          ...
          <nav id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="visible-xs-block">
                <h4 class="navbar-text text-center">Hi, Neeraj</h4>
              </li>
              <li class="dropdown">
                      ...
                      <a class="list-group-item" href="#">
                        <div class="notification">
                          <div class="notification-media">
                           <!--  <img class="rounded" width="40" height="40" src="<?= base_url(); ?>assets/<?= base_url(); ?>assets/img/0299419341.jpg" alt="Harry Jones"> -->
                          </div>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                 ...
                 <!--            <img class="rounded" width="40" height="40" src="<?= base_url(); ?>assets/img/0601274412.jpg" alt="Sophia Evans"> -->
                      ...
                      <a class="list-group-item" href="#">
                        <div class="notification">
                          <div class="notification-media">
                         <!--    <img class="rounded" width="40" height="40" src="<?= base_url(); ?>assets/img/0180441436.jpg" alt="Teddy Wilson"> -->
                          </div>
                          <div class="notification-content">
              ...
              <li class="dropdown hidden-xs">
               ...
               <img class="rounded" width="36" height="36" > <?= ucwords($_SESSION['user_name']); ?>
