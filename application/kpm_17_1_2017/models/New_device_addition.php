       ...
       for ($x = 1; $x <= count($query1); $x++)
        {
               $arr1=array(
                          ...
                          'imei' => $query1[$x]['imei'],
                          'thana_name' => $query1[$x]['thana_name'],
                          'veh_destination' => $query1[$x]['veh_destination'],
                          'veh_driver_name' => $query1[$x]['veh_driver_name'],
                          'veh_departuredate' => $query1[$x]['veh_departuredate'],
                          'driver_contact_no' => $query1[$x]['driver_contact_no'],
                           'veh_phone_number' => $query1[$x]['veh_phone_number'],
                          'card_number' => $query1[$x]['card_number'],
                           'veh_advance' => $query1[$x]['veh_advance']
                          );
       ...
       $query2 = $matrix_db->query($SELECT2)->result_array(); 
        for ($x = 1; $x <= count($query2); $x++)
        {
               $arr2=array(
                          ...
                          'driver_contact_no' => $query2[$x]['driver_contact_no'],
       ...
       $query4 = $matrix_db->query($SELECT4)->result_array(); 
        for ($x = 1; $x <= count($query4); $x++)
        {
               $arr4=array(
                          ...
                          'imei' => $query4[$x]['imei'],
                          'thana_name' => $query4[$x]['thana_name'],
                          'veh_destination' => $query4[$x]['veh_destination'],
                          'veh_driver_name' => $query4[$x]['veh_driver_name'],
                          'veh_departuredate' => $query4[$x]['veh_departuredate'],
                          'driver_contact_no' => $query4[$x]['driver_contact_no'],
                           'veh_phone_number' => $query4[$x]['veh_phone_number'],
                          'card_number' => $query4[$x]['card_number'],
                           'veh_advance' => $query4[$x]['veh_advance']
                          );
