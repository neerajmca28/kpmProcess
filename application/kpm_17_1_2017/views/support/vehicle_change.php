<div class="layout-content">
  <div class="layout-content-body">
    <div class="title-bar">
        ...
        <span class="d-ib">GPS Mapping to vehicle</span>
        </h1>
    </div>
    <div class="row">
      <div class="col-md-8">
  ...
  <?php
    ...
    $this->matrix_db = $CI->load->database('matrix_db', TRUE);
       ...
       <input type="hidden" name="hidden_imei" value="<?php echo $IMEI; ?>">
          ...
          <label class="col-sm-3 control-label" for="form-control-1">Old Vehicle No/IMEI:</label>
                 <select name="device_no_old"  class="form-control"  id="demo-select2-1"  required >
                      <option value=''>-- Select Vehicle/IMEI--</option>
                      <?php foreach($vehList as $row){ ?>{?>
                       <option value="<?php echo $row['id'];?>" ><?php echo $row['veh_reg']."--". $row['imei'];?></option>
                       <?php } ?>
                </select>
